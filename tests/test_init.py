...
@pytest.mark.parametrize(
    "data,result",
    [
        # Buggy server responding with extra byte
        ("5c 00 20 6b 00 4b a8", (RequestWrite(b""), MasterMessage(0x20))),
        # Frame from MODBUS40
        ("5c 00 20 6b 00 4b", (RequestWrite(b""), MasterMessage(0x20))),
        # Frame from RMU40
        ("5C 00 19 60 00 79", (CommandUnknown(0x60, b""), MasterMessage(0x19))),
        # Frame from RMU40
        (
        ...
        ("5C 00 20 69 00 49", (RequestRead(b""), MasterMessage(0x20))),
    ],
)
